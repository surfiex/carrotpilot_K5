...
class LongitudinalPlanner:
  ...
  def update(self, sm, frogpilot_planner):
    ...
    carrot_light_detect = not frogpilot_planner.conditional_experimental_mode

    self.mpc.update(sm, reset_state, carrot_light_detect, sm['radarState'], 
                    frogpilot_planner.v_cruise, x, v, a, j, 
                    frogpilot_planner.aggressive_acceleration, frogpilot_planner.increased_stopping_distance, frogpilot_planner.smoother_braking,
                    frogpilot_planner.custom_personalities, frogpilot_planner.aggressive_follow, frogpilot_planner.standard_follow, 
                    frogpilot_planner.relaxed_follow, personality=self.personality)
