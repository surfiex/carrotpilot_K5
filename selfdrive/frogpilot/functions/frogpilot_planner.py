...
class FrogPilotPlanner:
  ...
  def publish_lateral(self, sm, pm, DH):
    ...
    #carrot
    frogpilotLateralPlan.distanceToRoadEdgeLeft = float(DH.distance_to_road_edge_left)
    frogpilotLateralPlan.distanceToRoadEdgeRight = float(DH.distance_to_road_edge_right)
